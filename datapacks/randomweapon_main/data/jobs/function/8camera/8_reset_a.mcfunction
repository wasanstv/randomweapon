tellraw @a[tag=itemUsed8Selected2] {text:"당신은 한 점의 사진에 옥죄어졌습니다.",color:"red"}
tellraw @a[tag=itemUsed8Shutter] {text:"당신은 예쁜 사진을 건지는 데에 성공했습니다!",color:"green"}
...
execute at @a[tag=itemUsed8Selected2] run playsound item.totem.use block @a ~ ~ ~ 0.5 1
execute at @a[tag=itemUsed8Selected2] run particle block{block_state:"minecraft:redstone_block"} ~ ~1 ~ 0 0 0 0.2 100
